...
group = 'lim_paul_wgs84' \# Add a group name
...
overlayGroups = c("Crowns", "samples", "lim_paul_wgs84"), \# Add the new group
...
map <- leaflet(options = leafletOptions(maxZoom = 22)) %>%
  ...
  addFullscreenControl() %>%
  addLayersControl(
    overlayGroups = c("Crowns", "samples", "Lim. Amm. Paulilatino"),  # Add the new group
